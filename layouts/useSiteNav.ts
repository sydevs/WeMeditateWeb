 ...
 * is the one piece of chrome every layout shares.
 */
 ...
 *
 * This is a hook because the knowledge mega-menu shows two featured-article
 * thumbnails, picked at random once per mount (compute-once-and-reuse). The
