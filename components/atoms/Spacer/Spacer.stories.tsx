...
export const Default: Story = () => (
  <div className="flex flex-col gap-8">
    <div>
      <h3 className="text-lg font-semibold mb-4 text-gray-900">Vertical Spacing</h3>
    ...
    <div>
      <h3 className="text-lg font-semibold mb-4 text-gray-900">Horizontal Spacing</h3>
      <div className="border border-gray-200 rounded p-4">
    ...
    <div>
      <h3 className="text-lg font-semibold mb-4 text-gray-900">All Sizes Comparison</h3>
