...
export const Default: Story = () => (
  <div className="flex flex-col gap-8">
    <div>
      <h3 className="text-lg font-semibold mb-4 text-gray-900">Common Durations</h3>
    ...
    <div>
      <h3 className="text-lg font-semibold mb-4 text-gray-900">Format Variants</h3>
    ...
    <div>
      <h3 className="text-lg font-semibold mb-4 text-gray-900">Music Track List</h3>
