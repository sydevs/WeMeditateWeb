...
export interface LeafSvgProps extends ComponentProps<'svg'> {}

/**
 * Decorative leaf ornament used in dividers.
 * Original viewBox: 0 0 28.94 31.84
 */
export function LeafSvg({ className = 'w-[29px] h-8', ...props }: LeafSvgProps) {
  return (
    <svg
