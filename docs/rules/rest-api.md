...
factory adds this header for you, and `cmsFetch` ([server/cms-fetch.ts](../../server/cms-fetch.ts))
adds it to every read of a custom root endpoint. Nothing else composes that header.
