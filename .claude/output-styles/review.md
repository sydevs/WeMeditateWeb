...
- **Cross-reference** — when an issue relates to a project guide (`AGENTS.md`, `DESIGN_SYSTEM.md`, `STORYBOOK.md`, `MCP_USAGE.md`), a memory note, or prior commits, link to them.
...
- **Responsive / mobile-first** — does it follow the mobile-first requirements in AGENTS.md / DESIGN_SYSTEM.md?
